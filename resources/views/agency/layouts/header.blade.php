                        ...
                        <div class="header-dropdown-list message-menu" id="message-menu">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <span class="avatar avatar-md brround align-self-center cover-image"
                                            data-image-src="{{ URL::asset('assets/images/users/3.jpg') }}"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <span class="avatar avatar-md brround align-self-center cover-image"
                                            data-image-src="{{ URL::asset('assets/images/users/6.jpg') }}"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                            ...
                            <a class="dropdown-item border-bottom">
                                <div class="d-flex align-items-center">
                                    <div class="">
                                        <span class="avatar avatar-md brround align-self-center cover-image"
                                            data-image-src="{{ URL::asset('assets/images/users/7.jpg') }}"></span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="pl-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                        ...
                        <div class="notify-menu">
                            <a href="{{ url('/' . ($page = '#')) }}" class="dropdown-item border-bottom d-flex pl-4">
                                <div class="notifyimg bg-info-transparent text-info"> <i class="ti-comment-alt"></i>
                                </div>
                                <div>
                            ...
                            <a href="{{ url('/' . ($page = '#')) }}" class="dropdown-item border-bottom d-flex pl-4">
                                <div class="notifyimg bg-success-transparent text-success"> <i class="ti-desktop"></i>
                                </div>
                                <div>
                ...
                <div class="dropdown profile-dropdown">
                    @if (Auth::user()->type == 'agency')
                        ...
                        <a href="{{ url('/' . ($page = '#')) }}" class="nav-link pr-0 leading-none"
                            ...
                            <span>
                                <img src="{{ asset('assets/images/agency/' . $agency->image) }}" alt="img"
                    ...
                    @else
                        ...
                        <a href="{{ url('/' . ($page = '#')) }}" class="nav-link pr-0 leading-none"
                            data-toggle="dropdown">
                            <span>
                                <img src="{{ asset('assets/images/agent/' . $agent->image) }}" alt="img"
                                    class="avatar avatar-md brround">
                            </span>
                        </a>
                    @endif
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        ...
                        <a class="dropdown-item d-flex" href="{{ route('agency:logout') }}">
