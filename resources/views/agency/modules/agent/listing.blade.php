    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('agency:agent.form')}}" class="btn btn-primary"><i class="fe fe-user mr-1"></i> Add
                    New</a>
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('agency:agent.form', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="Edit"></i></li></a>
                                                    <a href="#">
