...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Agency Properties</h4>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('agency:properties.form') }}" class="btn btn-primary"><i class="fe fe-user mr-1"></i> Add
                    New</a>
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('agency:properties.form', ['id' => $item->id]) }}">
