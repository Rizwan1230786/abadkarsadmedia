    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('agency:properties') }}" class="btn btn-primary"><i class="fe fe-block mr-1"></i> Back </a>
            </div>
        </div>
    </div>
@endsection
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            if (isset($data['record']->id) && $data['record']->id != 0) {
                                $url = route('agency:properties_update', [$data['updateId'] ?? 0]);
                            } else {
                                $url = route('agency:properties_submit');
                            }
