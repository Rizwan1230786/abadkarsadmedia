                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                        <div class="small-category-2">
                            <div class="small-category-2-thumb img-1">
                                <a href="properties-map.html"><img src="{{ asset('assets/images/cities/' . $cities->image) }}"
                                        alt=""></a>
                            </div>
                            ...
                            <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 landscapes sale">
                                <div class="project-single" data-aos="fade-right">
                                    ...
                                    <div class="homes-content">
                                        <!-- homes address -->
                                        <h3><a
                                                href="{{ route('front.property_detail', $properties->id) }}">{{ $properties->name }}</a>
                                        </h3>
                                        ...
                                        <div class="price-properties footer pt-3 pb-0">
                                            <h3 class="title mt-3">
                                                <a href="{{ route('front.property_detail', $properties->id) }}">{{ $properties->price }}
                                                    {{ $properties->currency }}</a>
                                            </h3>
                                            <div class="compare">
                            ...
                            <div class="landscapes">
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        <!-- homes address -->
                                        <h3><a
                                                href="{{ route('front.project_detail', $projects->id) }}">{{ $projects->title }}</a>
                                        </h3>
                                        <p class="homes-address mb-3">
                                            <a href="{{ route('front.project_detail', $projects->id) }}">
