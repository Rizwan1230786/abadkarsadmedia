                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 col-md-6 py-1 pr-30 pl-0">
                                                                    ...
                                                                    <div class="form-group categories">
                                                                        <div class="nice-select form-control wide" tabindex="0"><span class="current"><i class="fa fa-home"></i>Property
                                                                                Status</span>
                                                                            <ul class="list">
                        ...
                        <div class="homes-content">
                            ...
                            <p class="homes-address mb-3">
                                <a href="{{ url('/property', $properties->url_slug) }}">
                                    <i class="fa fa-map-marker"></i><span>{{ $properties->city_name }}</span>
                                </a>
                            </p>
                            <!-- homes List -->
