                            ...
                            <div class="small-category-2">
                                <div class="small-category-2-thumb img-1">
                                    <a href="properties-map.html"><img
                                            src="{{ asset('assets/images/cities/' . $cities->image) }}" alt=""></a>
                                </div>
                                    ...
                                    <div class="project-single" data-aos="fade-right">
                                        <div class="project-inner project-head">
                                            <div class="homes">
                                                ...
                                                <a href="{{ url('/property', $properties->url_slug) }}"
                                                    class="homes-img"
                                                    style="background-image: url('{{ asset('assets/images/properties/' . $properties->image) }}');">
                                                    <div class="homes-tag button alt featured">Featured</div>
                                                    <div class="homes-tag button alt sale">For Sale</div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="price-properties footer pt-3 pb-0">
                                                <h3 class="title mt-3">
                                                    <a href="{{ route('front.property_detail', $properties->id) }}">
                                                        {{ $properties->currency }}: {{ $properties->price }}</a>
                                                </h3>
                                                <div class="compare">
                                                    <a href="#" title="Compare">
                                                        <i class="flaticon-compare"></i>
                                        ...
                                        <div class="project-inner project-head">
                                            <div class="homes">
                                                ...
                                                <a href="{{ url('/project', $projects->url_slug) }}"
                                                    class="homes-img"
                                                    style="background-image: url('{{ asset('assets/images/projects/' . $projects->image) }}') ">
                                                    <div class="homes-tag button alt featured">Featured</div>
                                                    <div class="homes-tag button alt sale">For Sale</div>
                                                </a>
                                            </div>
