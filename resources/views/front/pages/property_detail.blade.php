                        ...
                        @if ($image->property_id == $properties->id)
                            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                ...
                                <img class="d-block w-100"
                                    src="{{ is_null($image->file) ? asset('assets/images/properties/multipleimages/webp/' . $image->image_webp) : asset('assets/images/properties/' . $image->image) }}"
                                    alt="First slide" style="height:450px">
                                <?php } else { ?>
                                <img class="d-block w-100"
                                    src="{{ is_null($image->file) ? asset('assets/images/properties/multipleimages/jpg/' . $image->image) : asset('assets/images/properties/' . $image->image) }}"
                                    alt="First slide" style="height:450px">
                                <?php } ?>
                            </div>
                        @endif
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12 blog-pots">
                                                ...
                                                <div class="listing-title-bar">
                                                    ...
                                                    <div class="mt-0">
                                                        <a href="#listing-location" class="listing-address">
                                                            <i
                                                                class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>
                                                            {{ $properties->location }}
                                                        </a>
                                                        @if (isset($properties->location))
                                                            <div class="map-responsive">
                                                                <iframe
                                                                    src="https://maps.google.com/maps?q={{ $properties->latitude }},{{ $properties->longitude }}&output=embed"
                                                        ...
                                                        @else
                                                            <div class="map-responsive">
                                                                <iframe
                                                                    src="https://maps.google.com/maps?q={{ $properties->city_name }}&output=embed"
                                                                    width="600" height="450" frameborder="0"
                                                                    style="border:0" allowfullscreen></iframe>
                                                            </div>
                                                        @endif
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                <li>
                                    <span><a style="text-decoration: none;color: black;"
                                            href="{{ $properties->video_link }}">Click Here!</a></span>
                                </li>
                            </ul>
                        </div>
        ...
        <footer class="first-footer rec-pro">
            ...
            <div class="second-footer rec-pro">
                <div class="container-fluid sd-f">
                    <p style="text-align: center">2022 © Copyright <a
                            href="{{ url('https://abadkar.com//') }}">Abadkar</a> - All Rights Reserved.</p>
