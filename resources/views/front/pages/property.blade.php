                    ...
                    <div class="project-single mb-0 bb-0">
                        <div class="project-inner project-head">
                            <div class="project-bottom">
                                <h4><a href="{{ route('front.property_detail') }}">View Property</a><span class="category">Real Estate</span></h4>
                            </div>
                            <div class="homes">
                                <!-- homes img -->
                                <a href="{{ route('front.property_detail') }}" class="homes-img">
                            ...
                            <div class="button-effect">
                                <a href="{{ route('front.property_detail') }}" class="btn"><i class="fa fa-link"></i></a>
                                <a href="https://www.youtube.com/watch?v=2xHQqYRcrx4" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                <a href="{{ route('front.property_detail') }}" class="img-poppu btn"><i class="fa fa-photo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="project-inner project-head">
                            ...
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">Family Home</div>
                                    <img src="{{ asset('/front') }}/images/feature-properties/fp-4.jpg" alt="home-1" class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                                <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                        ...
                        <div class="project-inner project-head">
                            ...
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">Family Home</div>
                                    <img src="{{ asset('/front') }}/images/feature-properties/fp-5.jpg" alt="home-1" class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                                <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                        ...
                        <div class="project-inner project-head">
                            ...
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">Family Home</div>
                                    <img src="{{ asset('/front') }}/images/feature-properties/fp-6.jpg" alt="home-1" class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                                <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
                        ...
                        <div class="project-inner project-head">
                            ...
                            <div class="homes">
                                ...
                                <a href="single-property-1.html" class="homes-img">
                                    ...
                                    <div class="homes-tag button alt sale">For Sale</div>
                                    <div class="homes-price">Family Home</div>
                                    <img src="{{ asset('/front') }}/images/feature-properties/fp-7.jpg" alt="home-1" class="img-responsive">
                                </a>
                            </div>
                            <div class="button-effect">
                                <a href="single-property-1.html" class="btn"><i class="fa fa-link"></i></a>
