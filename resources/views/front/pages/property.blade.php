        ...
        <div class="container">
                    ...
                    <div class="project-single mb-0 bb-0">
                        <div class="project-inner project-head" style="background-image: url('{{ asset('assets/images/properties/' . $search_property->image) }}');  background-size: cover;
                            ...
                            <div class="button-effect">
                                ...
                                <a href="{{ $search_property->video }}" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                @endif
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="{{ $item->id == $url_slug->category_id ? 'active' : '' }}">
                        <a href="/#{{ $item->name }}" aria-controls="home" role="tab" data-toggle="tab">{{ $item->name }}</a>
                    </li>
                    @endforeach
                </ul>
                <div class="tab-content">
                    @foreach ($category as $item)
                    <div role="tabpanel" class="tab-pane {{ $item->id == $url_slug->category_id ? 'active' : '' }}" id="{{ $item->name }}" class="active">
                        <ul class="nav nav-tabs" style="display: table-header-group">
                            ...
                            <li style="list-style: square">
                                <a href="{{ url('/property' . '/' . $item->name . '/' . $get_city_name->slug . '/' . $area->slug) }}">{{ $area->areaname }}</a>
                            </li>
                            @endforeach
                            @endforeach
                        </ul>
            ...
            <div class="row featured portfolio-items">
                <div class="item  mb-5 col-lg-4 col-md-12 col-xs-12 landscapes sale pr-0 pb-0" data-aos="fade-up">
                    <div class="project-single mb-0 bb-0">
                        <div class="project-inner project-head" style="background-image: url('{{ asset('assets/images/properties/' . $city_search_property->image) }}');  background-size: cover;
                            ...
                            <div class="homes">
                                <!-- homes img -->
                                <a href="{{ url('/property', $city_search_property->url_slug) }}" class="homes-img">
                                    <div class="homes-tag button alt featured">Featured</div>
                            ...
                            <div class="button-effect">
                                ...
                                <a href="{{ $city_search_property->video }}" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                @endif
                                <a href="#" class="img-poppu btn"><i class="fa fa-photo"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12 homes-content pb-0  mb-5" data-aos="fade-up">
                    <!-- homes address -->
                    <h3><a href="{{ url('/property' . '/' . $city_search_property->url_slug) }}">{{ $city_search_property->name }}</a>
                    </h3>
                    <p class="homes-address mb-3">
            ...
            <div class="row featured portfolio-items">
                <div class="item mb-5 col-lg-4 col-md-12 col-xs-12 landscapes sale pr-0 pb-0" data-aos="fade-up">
                    <div class="project-single mb-0 bb-0">
                        <div class="project-inner project-head" style="background-image: url('{{ asset('assets/images/properties/' . $area_search_propertys->image) }}');  background-size: cover;
                            ...
                            <div class="homes">
                                <!-- homes img -->
                                <a href="{{ url('/property', $area_search_propertys->url_slug) }}" class="homes-img">
                                    <div class="homes-tag button alt featured">Featured</div>
                            ...
                            <div class="button-effect">
                                ...
                                <a href="{{ $area_search_propertys->video }}" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                @endif
                                <a href="$" class="img-poppu btn"><i class="fa fa-photo"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12 homes-content pb-0 mb-5" data-aos="fade-up">
                    <!-- homes address -->
                    <h3><a href="{{ url('/property', $area_search_propertys->url_slug) }}">{{ $area_search_propertys->name }}</a>
                    </h3>
                    <p class="homes-address mb-3">
            ...
            <div class="row featured portfolio-items">
                    ...
                    <div class="project-single mb-0 bb-0">
                        <div class="project-inner project-head" style="background-image: url('{{ asset('assets/images/properties/' . $properties->image) }}');  background-size: cover;
                            ...
                            <div class="button-effect">
                                <a href="#" class="btn"><i class="fa fa-link"></i></a>
                                @if ($properties->video)
                                <a href="{{ $properties->video }}" class="btn popup-video popup-youtube"><i class="fas fa-video"></i></a>
                                @endif
                                <a href="$" class="img-poppu btn"><i class="fa fa-photo"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12 homes-content pb-0 mb-5" data-aos="fade-up">
                    <!-- homes address -->
                    <h3><a href="{{ url('/property', $properties->url_slug) }}">{{ $properties->name }}</a>
                    </h3>
                    <p class="homes-address mb-3">
