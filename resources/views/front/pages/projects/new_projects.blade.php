                                                ...
                                                <div class="tab-pane fade" id="tabs_3">
                                                    <div class="rld-main-search">
                                                        <div class="row">
                                                            ...
                                                            <div class="rld-single-select">
                                                                <input class="form-control single-select" type="text" name="project_title" placeholder="Project Title">
                                                            </div>
                                                            <div class="dropdown-filter"><span>Advanced Search</span>
                                                            </div>
                                                            <div class="col-xl-2 col-lg-2 col-md-4 pl-0">
                                                            ...
                                                            <div class="explore__form-checkbox-list full-filter">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="rld-single-select">
                                                                        <input class="form-control single-select" type="text" name="developer_title" placeholder="Developer Title">
                                                                    </div>
                                                                    <div class="rld-single-select">
                                                                        <input class="form-control single-select" type="text" name="land_area2" placeholder="Enter area size...">
                                                                    </div>
                                                                    ...
                                                                    <div class="rld-single-select" style="display: inline-flex;">
                                                                        <input class="form-control single-select" type="text" name="min_price" placeholder="Enter minimum price..." style="margin-right: 10px;">
                                                                        <input class="form-control single-select" type="text" name="max_price" placeholder="Enter maximum price...">
                                                                    </div>
                                                                </div>
                        ...
                        <div class="item">
                            <div class="shadow-effect" style="margin-top: 100px;">
                                <span class="mytooltip tooltip-effect-1">
                                    <img class="img-responsive caruswl-image tooltip-item" src="{{ asset('assets/images/agency/' . $value->image) }}" alt="">

                                    <span class="tooltip-content clearfix">
                                        <img src="{{ asset('assets/images/agency/' . $value->image) }}">
                                        <span class="tooltip-text">
                                            <i class="fas fa-map-marker-alt"></i>&nbsp;&nbsp;{{ $value->office_address }}<br>
                                            <i class="fas fa-phone-alt" style="color: white"></i>&nbsp;&nbsp;{{ $value->mobile_number }}<br>
                                            <i class="fas fa-phone-alt" style="color: white"></i>&nbsp;&nbsp;{{ $value->office_number }}
                                        </span>
                                    </span>
                                </span>
                            </div>
