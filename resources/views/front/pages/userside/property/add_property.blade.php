                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 dropdown faq-drop">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="inlineCheckbox1" value="sale">
                                            <label class="form-check-label" for="inlineCheckbox1">For Sale</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="inlineCheckbox2" value="rent">
                                    ...
                                    <div class="col-lg-8 col-md-12 dropdown faq-drop">
                                        <div class="property-form-group">
                                            <div class="col-12 form-group padding">
                                                ...
                                                <input type="radio" class="form-switch1" data-id="c" name="radio" id="three">
                                                <label for="three" class="lable radio_container" style="width: 100px;">Commercials</label>
                                        ...
                                        <div class="row form1 form1-a">
                                            <div class="col-lg-6 col-md-12">
                                                <input type="radio" class="form-switch1" name="colorCheckbox" value="green" style="margin-left: 10px;">
