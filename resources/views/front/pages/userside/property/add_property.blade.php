                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb first" style="margin-bottom: 4px;">
                                                ...
                                                <input type="number" value="{{old('latitude')}}" name="latitude" step="0.01"
                                                    placeholder="Google Maps latitude" id="latitude">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last" style="margin-bottom: 4px;">
                                                ...
                                                <input type="number" value="{{old('longitude')}}" name="longitude" step="0.01"
                                                    placeholder="Google Maps longitude" id="longitude">
                                                <a class="form-control notrequired" style="background-color: #d9edf7"
                                                    href="https://www.latlong.net/convert-address-to-lat-long.html"
                                                    target="_blank" rel="nofollow">
                                    ...
                                    <div class="row form form-a active">
                                        <div class="col-lg-6 col-md-12">
                                            <p>
                                                ...
                                                <input type="email" value="{{old('email')}}" placeholder="Enter Your Email" id="con-user"
                                                    name="email">
                                                @if ($errors->has('email'))
                                    ...
                                    <div class="row form form-b">
                                        <div class="col-lg-6 col-md-12">
                                            <p>
                                                ...
                                                <input type="text" value="{{old('firstname')}}" placeholder="Enter Your Name" id="con-name"
                                                    name="firstname">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p>
                                                ...
                                                <input type="text" value="{{old('lastname')}}" placeholder="Enter Your Username" id="con-user"
                                                    name="lastname">
                                    ...
                                    <div class="row form form-b">
                                        ...
                                        <div class="col-lg-6 col-md-12 Rent msg">
                                            <p class="no-mb last">
                                                ...
                                                <input type="text" value="{{old('contact')}}" placeholder="Enter Your Phone Number" id="con-phn"
                                                    name="contact">
