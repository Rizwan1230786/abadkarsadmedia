                                        ...
                                        <div class="col-lg-8 col-md-12 dropdown faq-drop">
                                            <div class="property-form-group">
                                                <div class="col-12 form-group padding">
                                                    ...
                                                    <input type="radio" class="form-switch1" name="colorCheckbox"
                                                        value="red" data-id="a" checked style="margin-left: 10px;">
                                                    <label for="Sale">Homes</label>
                                                    <input type="radio" class="form-switch1" name="colorCheckbox"
                                                        value="green" data-id="b" style="margin-left: 10px;">
                                                    <label for="Rent">Plots</label>
                                                    <input type="radio" class="form-switch1" name="colorCheckbox"
                                                        value="green" data-id="c" style="margin-left: 10px;">
                                                ...
                                                <div class="row form1 form1-a">
                                                    <div class="col-lg-6 col-md-12">
                                                        <input type="radio" class="form-switch1" name="colorCheckbox"
                                                            value="green" style="margin-left: 10px;">
