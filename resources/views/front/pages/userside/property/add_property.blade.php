                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb first" style="margin-bottom: 4px;">
                                                ...
                                                <input type="number" value="{{ old('latitude') }}" name="latitude"
                                                    step="0.01" placeholder="Google Maps latitude" id="latitude">
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <p class="no-mb last" style="margin-bottom: 4px;">
                                                ...
                                                <input type="number" value="{{ old('longitude') }}" name="longitude"
                                                    step="0.01" placeholder="Google Maps longitude" id="longitude">
                                                <a class="form-control notrequired" style="background-color: #d9edf7"
                                                    href="https://www.latlong.net/convert-address-to-lat-long.html"
                                                    target="_blank" rel="nofollow">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12">
                                                <p class="no-mb">
                                                    ...
                                                    <input style="border-radius: 5px;" type="number" value="{{ old('price') }}" name="front_dimantion"
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <p class="no-mb" style="margin-bottom: 4px;">
                                                    ...
                                                    <input type="number" value="{{ old('price') }}" name="back_dimantion"
                                                        placeholder="" id="price">
                                                </p>
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <p class="no-mb" style="margin-bottom: 4px;">
                                                    ...
                                                    <input type="number" value="{{ old('price') }}" name="area_size"
                                                        placeholder="" id="price">
                                                </p>
