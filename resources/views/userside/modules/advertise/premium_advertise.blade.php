    ...
    <input type="hidden" id="session_user_id" value="1001388906" /> -->
        ...
        <div class="box_body">
            <div id="" style="height:auto;margin-left: 25px;">
                <ul style="list-style-type: disc;margin: 5px;padding: 7px;line-height: 2;">
                    <li>All features of basic listings plus</li>
                    <li>400% extra traffic and exposure as compared to basic listings.</li>
                    <li>Top ranks on category pages and property searches.</li>
                    <li>Receive direct emails - bypass Zameen inbox.</li>
                    <li>Option to upload premium listings via excel.</li>
                    <li>Other features include preferred inclusion in alerts, advanced reports and stats, dedicated account
                        manager and guaranteed leads generation.</li>
                </ul>
            </div>
        </div>
            ...
            <div id="data_data" style="height:auto">
                ...
                <div id="credits-body">
                    <div class="row" style="font-weight: 700;" id="product_1">
                        ...
                        <!-- Type -->
                        <span style="width:40%"> &nbsp;{{ $premium->name ?? ''}} &nbsp; <a href="javascript:void(0)"
                        ...
                        <span style="width:40%">
                        <!-- Price -->
                        <span class="product_unit_price" data-product_price="200" style="width:10%"> &nbsp;{{ $premium->price ??''}} </span>
                        <!-- Total Price -->
                        <!-- Controls -->
                        </span>
                        <span style="width:10%">
                            <a href="{{ route('add.to.cart', $premium->id ?? '') }}" class="add_insert_to_cart"
        ...
        <div class="" style="float:left; height:auto; width: 100%; margin-bottom: 4%;">
            <div style="/*text-align: center;*/ width: 80%; margin-left: 10%">
                <img width="100%"
                    src="{{ asset('userside') }}/common/adv/premium-listing.jpg">
            </div>
        </div>
    </div>
    </div>
