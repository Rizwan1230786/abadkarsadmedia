    ...
    <div id="maincontent">
        ...
        <div id="rightcolumn" style="
            ...
            <div style="height:30px;margin-bottom:10px; display: block;" id="bc_container">
                ...
                <span class="worddashbord" style="display:inline;">Dashboard </span>
            </div>
            <script type="text/javascript">
                var expiry_credit_details_msg = "";
            </script>
            <!-- Google Ads display -->
            ...
            <div id="main_quotadiv_heading" style="display:block;">
                <div class="tab_menu" style="margin-top: 11.5px !important;">
                    <div class="selected" id="a_quotalisting">
                        ...
                        <a onclick="I('a_storyadcredits').className='';I('quotastoryaddiv_heading').style.display='none';I('a_superhotcredits').className='';I('quotasuperhotdiv_heading').style.display='none';I('a_hotcredits').className='';/*I('a_mgzcredits').className='';*/I('quotahotdiv_heading').style.display='none';I('a_quotalisting').className='selected';I('quotadiv_heading').style.display='block';/*I('quotamgzdiv_heading').style.display='none';*/ I('a_refreshlisting').className='';I('quotarefreshdiv_heading').style.display='none';/*I('a_interlisting').className='';I('quotainterdiv_heading').style.display='none';*/"
                            href="javascript: void(0);">Premium Listings <span class="heading_tab_small">(5)</span></a>
                    </div>
                ...
                <div id="quotahotdiv_heading" style="height:auto;display:none;">
                    ...
                    <div style="float:right; width:155px;padding:0px 10px;">
                        <div class="subquotaheading">
                            <span style="width:155px;font-weight:bold;padding-bottom:15px;text-align:right;"><a
                                    href='https://profolio.zameen.com/profolio/index.php?tabs=13&section=advertise&product=4'
                                    target="_blank">
                                    <font class="orangeTxt">Buy Hot Listings</font>
                                </a>&nbsp;<a href="javascript:void(0);" class="propinfo_link"
                                    onmouseover="return overlib('1. Please contact us via e-mail or call us on 0800-ZAMEEN (92633), +92 42 32560445 (9:am to 6:00pm working days) to purchase Hot Listings<br /><br />2. After you have purchased Hot Property Listings, you can turn any basic listing into a Hot listing by simply clicking the Chilli [ <img src=https://profolio.zameen.com/images/common/grey_chilli.png border=0> ] button in your property controls. The image will turn red [ <img src=https://profolio.zameen.com/images/common/hot_icon.png border=0> ] if the listing is successfully updated.<br ><br />3. A single hot listing credit will be deducted from your quota and your listing will remain hot for a period of <b>30 days</b> after which the status will automatically change to a basic listing.<br /><br />4. Just a word of advice: Once a credit has been utilized, it cannot be re-used, so select your basic listing carefully and make sure that you want to turn it Hot.',CAPTION,'How to use Hot Property Listing Credits',WIDTH,550,LEFT,ABOVE,CELLPAD, 7);"
                                    onmouseout="return nd();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span> <span
                                style="width:155px; font-weight:bold;padding-bottom:15px;text-align:right;"><a
                                    href='https://profolio.zameen.com/profolio/index.php?tabs=13&section=advertise&product=2'
                                    target="_blank">
                                    <font class="active_txt">Buy Listings Package</font>
                                </a>&nbsp;<a href="javascript:void(0);" class="propinfo_link"
                                    onmouseover="return overlib('All accounts come with a limited quota of <b>5 free basic listing</b> credits which means you can have 5 active listings at any given time.<br /><br />If you wish to<strong> increase your listings quota </strong>then please purchase one of our listing packages.<br /><br />For further information please visit our advertise page or contact us via e-mail or call us on <strong>+92 42 3256 0445</strong> (9:am to 5:00pm working days) <br /><br /><b>Note:</b> Each listing credit acts as a listing slot. When you delete a listing, the credit is redeemed and becomes available to be used for a new listing.',CAPTION,'Increase Listing Quota',WIDTH,550,LEFT,ABOVE,CELLPAD, 7);"
                                    onmouseout="return nd();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span>
                        </div>
                    </div>
                    ...
                    <div style="float:left;width:605px;padding:5px;">
                        <div class="quota_div_block" style="width:110px;">
                            ...
                            <div>Hot Credits</div>
                            <div style="width:500px;padding:24px 0px 5px;">Click <a href="" style='color:#0E77B0;'
                                    target="_blank">here</a> to purchase more hot listing credits
                            </div>
                        </div>
                        ...
                        <div style="width: 100%">
                            <div style="width: 100%; float: left; margin-left: 7px; margin-bottom: 10px;">
                                ...
                                <span class="showMoreDiv 0" style="padding-left: 17px; cursor: pointer;">
                                    ...
                                    <span>
                                        <a class="showMoreText" href="javascript:;"
                                            style="font-size: 10px; color:#0E77B0;;">Show Details</a>
                                    </span>
                                </span>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td colspan='4'>
                                                <div class='titlebar'><span
                                                        style='width:22%; text-align: left;padding-left:5px;'>Expiry
                ...
                <div id="quotarefreshdiv_heading" style="height:auto;display:none;">
                    ...
                    <div style="float:left;width:605px;padding:5px 0px 5px 5px;">
                        <div class="quota_div_block" style="width: 150px;">
                            <div class="quota_div_block_title">Total Credits</div>
                            <div class="quota_number_text">0</div>
                            <div style="width:500px;padding:25px 0px 5px;">Click <a href="#" style='color:#0E77B0;'
                                    target="_blank">here</a> to purchase more Refresh listing credits
                            </div>
                    ...
                    <div style="float:left;width:605px;padding:5px;">
                        ...
                        <div class="quota_div_block" style="width:110px;">
                            ...
                            <div style="width:500px;padding:5px 0px;padding-top: 60px !important;">To increase listing quota
                                please <a href="#" target="_blank">contact us</a> or purchase a <a href="#"
                                    style='color:#0E77B0;' target="_blank">premium listing</a>.</div>
                        </div>
            ...
            <div id="statistics_graph" style="margin-top: 35px;">
                <h3>Your Performance (last 30 days)
                    <img src="{{ asset('front/images/abadkar-logo.png') }}" width="130" height="25"
                        style="float: right;margin-top: 19px;" />
                </h3>
                <div class="box_heading_selected">
                    <div id="0" class="stat_button"><b>Property Views</b></div>
                </div>
                <div class="box_heading">
                    <div id="1" class="stat_button"><b>Property Visits</b></div>
                </div>
                <div class="box_heading">
                    <div id="6" class="stat_button"><b>CTR</b></div>
                </div>
                <div class="box_heading">
                    <div id="3" class="stat_button"><b>Emails Received</b></div>
                </div>
                <div class="box_heading">
                    <div id="2" class="stat_button"><b>Phone Views</b></div>
                </div>
                <div class="box_heading">
                    <div id="4" class="stat_button"><b>SMS Clicks</b></div>
                </div>
                <div id="statdiv_heading" style="min-height: 300px;">
                    <div align="center">
                        <div id="chart_1">
            ...
            <div id="recently" style="margin-top: 35px;">
                <div class="box_title">
                    <div><b>My Recent Listings</b></div>
                </div>
