    ...
    <script type="text/javascript">
        ...
        window.NREUM || (NREUM = {}), __nr_require = function(t, e, n) {
            ...
            1: [function(t, e, n) {
                ...
                function i(t, e, n, r) {
                    return function() {
                        return s.recordSupportability("API/" + e + "/called"), o(t + e, [u.now()]
                            .concat(c(arguments)), n ? null : this, r), n ? void 0 : this
                    }
                }
                var o = t("handle"),
                    a = t(9),
                ...
                a(p, function(t, e) {
                    d[e] = i(l, e, !0, "api")
                }), d.addPageAction = i(l, "addPageAction", !0), d.setCurrentRouteName = i(l,
                ...
                a("actionText,setName,setAttribute,save,ignore,onEnd,getContext,end,get".split(","),
                    ...
                    "string" == typeof t && (t = new Error(t)), s.recordSupportability(
                        "API/noticeError/called"), o("err", [t, u.now(), !1, e])
                }
            }, {}],
            2: [function(t, e, n) {
                function r(t) {
            ...
            5: [function(t, e, n) {
                function r() {
                    return c.exists && performance.now ? Math.round(performance.now()) : (o = Math.max((
            ...
            6: [function(t, e, n) {
                ...
                function c(t) {
                    if (t instanceof y && !w) {
                        ...
                        a(n), e <= v.now() ? n.fid = v.now() - e : e > v.offset && e <= Date.now() ? (e -= v
                            .offset, n.fid = v.now() - e) : e = v.now(), w = !0, l("timing", ["fi", e,
                            n])
                    }
                }
            ...
            7: [function(t, e, n) {
                ...
                if (navigator.userAgent) {
                    var c = navigator.userAgent,
                        f = c.match(a);
                    f && c.indexOf("Chrome") === -1 && c.indexOf("Chromium") === -1 && (i = "Safari", o = f[
                        1])
                }
                e.exports = {
                    agent: i,
            ...
            8: [function(t, e, n) {
                ...
                e.exports = r;
                var o, a, c;
                "undefined" != typeof document.hidden ? (o = "hidden", a = "visibilitychange", c =
                    "visibilityState") : "undefined" != typeof document.msHidden ? (o = "msHidden", a =
                    "msvisibilitychange") : "undefined" != typeof document.webkitHidden && (o =
                    "webkitHidden", a = "webkitvisibilitychange", c = "webkitVisibilityState")
            }, {}],
            9: [function(t, e, n) {
                function r(t, e) {
                    var n = [],
            ...
            loader: [function(t, e, n) {
                function r() {
                    if (!M++) {
                        ...
                        0 === t.agent.indexOf("http://") || 0 === t.agent.indexOf("https://") ? r.src = t
                            .agent : r.src = l + "://" + t.agent, e.parentNode.insertBefore(r, e)
                    }
                }
                ...
                if (!b) {
                    t(1), t(6), m[g] ? (m[g]("DOMContentLoaded", o, p(!1)), v[g]("load", r, p(!1))) : (m[y](
                        "onreadystatechange", i), v[y]("onload", r)), c("mark", ["firstbyte", a
                        .getLastTimestamp()
                    ], null, "api");
                    var M = 0
                }
            ...
            "wrap-function": [function(t, e, n) {
                function r(t, e) {
                    ...
                    function r(t, e, r, i, o) {
                        ...
                        for (u = 0; u < e.length; u++) f = e[u], c = t[f], a(c) || (t[f] = n(c, s ? f + r :
                            r, i, f, o))
                    }
                ...
                var s = t("ee"),
                    ...
                    v = !1;
                e.exports = r, e.exports.wrapFunction = c, e.exports.wrapInPlace = f, e.exports
                    .argsToArray = u
            }, {}]
        }, {}, ["loader"]);
    </script>
    ...
    <div id="content" class="" style="font-family:Arial,Verdana,Helvetica,sans-serif;line-height:140%;">
        ...
        <div id="header">
            ...
            <a href="https://profolio.zameen.com/profolio/">
                <div id="headerleftcorner"
                    style="background:url('https://profolio.zameen.com/images/common/logo_software.gif') 10px 0px no-repeat;">
                </div>
            </a>
        </div>

        <div id="mybayut_tabs">
            <li><a href='https://profolio.zameen.com/profolio/index.php'>Dashboard</a></li>
            <li id=current><a
                    href='https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=on'>Property
                    Management</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?section=mailbox_inbox&tabs=3&type=u'>Message
                    Center</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=4&section=editUser'>My Account &
                    Profiles</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=10&section=reports'>Reports</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=6&section=favourites'>Tools</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=7&section=agedit_user'>Agency Staff</a>
            </li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=8&section=inquiries&subsection=lead_summary'
                    class='client_n_leads'>Clients & Leads</a></li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=12&section=agency_ws'>Agency Website</a>
            </li>
            <li><a href='https://profolio.zameen.com/profolio/index.php?tabs=13&section=advertise'>Advertise</a></li>
     ...
     ">0
                ...
                <a href="https://profolio.zameen.com/profolio/index.php?tabs=13&section=billing" rel="nofollow"
                    class="menu_list transparent billing_icon icon-utl" id="header_billing">Billing</a>
                <a href="https://profolio.zameen.com/profolio/index.php?tabs=6&section=edit_advance_alerts"
                    class="menu_list email_alert_icon icon-utl transparent">Email Alert</a>
                <a href="https://www.zameen.com/blog/" rel="nofollow" id="header_blog"
                    class="menu_list transparent blog_icon icon-utl">Blog</a>

                <a href="https://www.zameen.com/advertise/index.html" rel="nofollow" id="header_advertise"
                    class="menu_list transparent advertise-icon icon-utl">Advertise</a>
            </div>
            <div class="right">

                <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=inventory_search"
                    class="menu_list invent_search_icon icon-utl">Inventory Search</a>

                <a href="index.php?tabs=2&section=add_property" target="_self"
                    class="menu_list post_list_icon icon-utl">Post Listing</a>
            </div>
        ...
        <div id="maincontent">
            ...
            <div id="leftcolumn">
                <div id="mybayut_menu">
                    ...
                    <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=inventory_search"
                        class="leftcolumnlink">Inventory Search</a>
                    <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=add_property"
                        class="leftcolumnlink">Post New Listing</a>
                    <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=zone_details"
                        class="leftcolumnlink">Zone Details</a>
                    <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listing_policy"
                        class="leftcolumnlink">Listing Policy</a>
                    ...
                    <div class="listing_class" style="display:none;" id="d_active">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=on"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=on"
                            class="leftcolumnlink">For Sale (1)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=on"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                        <!--</a>-->
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Super_Hot_Listing&status=on"
                            class="leftcolumnlink">Super Hot Listings (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Hot_Listing&status=on"
                    ...
                    <div class="listing_class" style="display:none;" id="d_edited">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=edited"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=edited"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=edited"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_pending">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=Pending"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=Pending"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=Pending"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_expired">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=expired"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=expired"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=expired"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_uploaded">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=u"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=u"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=u"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_hidden">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=hidden_listings"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=hidden_listings"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=hidden_listings"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_deleted">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=Deleted"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=Deleted"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=Deleted"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_rejected">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=Rejected"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=Rejected"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=Rejected"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <div class="listing_class" style="display:none;" id="d_downgraded">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&status=downgraded"
                            class="leftcolumnlink">All Listings</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Sale&status=downgraded"
                            class="leftcolumnlink">For Sale (0)</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=listings&subsection=Rent&status=downgraded"
                            class="leftcolumnlink">For Rent (0)</a>
                        <!--		<a href="-->
                        <!--/index.php?tabs=2&section=listings&subsection=Wanted&status=-->
                        <!--" class="leftcolumnlink">-->
                    ...
                    <a href="javascript:void(0);" class="leftcolumnlink_sub" id="rejected_images_head"
                        ...
                        Rejected Images
                        <!-- <label><img style="margin-top: -10px;position: absolute;" src="https://profolio.zameen.com/images/common/new_img_small.png"></label> -->
                    </a>
                    <div class="listing_class" style="display:none;" id="rejected_images_body">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_images"
                            class="leftcolumnlink">All Images</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_images&purpose=sale"
                            class="leftcolumnlink">Sales </a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_images&purpose=rent"
                    ...
                    <div class="listing_class" style="display:none;" id="rejected_videos_body">
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_videos"
                            class="leftcolumnlink">All Videos</a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_videos&purpose=sale"
                            class="leftcolumnlink">Sales </a>
                        <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=rejected_videos&purpose=rent"
                            class="leftcolumnlink">For Rent</a>
                        <!--	<a href="-->
                    ...
                    <a href="https://profolio.zameen.com/profolio/index.php?tabs=2&section=expiry_log"
                        class="leftcolumnlink">View Log</a>
                    ...
                    <form name="frm_ref" id="frm_ref" action="?tabs=2&section=inventory_search" method="post">
                        Search:&nbsp;
                        <input type="text" id="txt_idref" class="auto_textbox empty" name="txt_idref"
                            defvalue="ID or Ref" value="ID or Ref" style="width:93px" />&nbsp;<img
            ...
            <div id="rightcolumn" style="width:79% " class="rightcolumn_div post_story_margin">
                ...
                <div style="height:30px;margin-bottom:10px; display: block;" id="bc_container">
                    ...
                    <span class="worddashbord" style="display:inline;"> <a
                            href="index.php?tabs=2&section=listings">Property Management</a> &raquo; Post Listing
                    </span>
                </div>
                <link rel="stylesheet" href="https://profolio.zameen.com/css/post_listing_individual_2_1.css?v=37"
                    type="text/css">
                <script type="text/javascript">
                        ...
                        <div class="post-listing-credit-box" style="display: none;">
                            ...
                            <div class="contact-credit-info">
                                <div class="zameen-details">
                                    <div>
                                        <img src="https://assets.zameen.com/profolio/images/post_listing_credit_box_zlogo1_1.svg"
                                ...
                                <div class="olx-details">
                                    <div>
                                        <img src="https://assets.zameen.com/profolio/images/post_listing_credit_box_olx_logo1_1.svg"
                                            width="27" alt="OLX">
                                    </div>
                                    <div class="number">
                        ...
                        <form class="add_property add_property_form singleForm clr" method="post" autocomplete="off"
                            ...
                            <div class="divrow">
                                ...
                                <ul id='purpose_push_buttons' class='l push_buttons'>
                                    ...
                                    <li class='l pushBtnLabel ' id='purpose_label_2'
                                        onclick='pushBtnClick(this,"purpose","2")' title='Rent'>
                            ...
                            <div class="divrow">
                                ...
                                <ul id='ptype_push_buttons' class='l push_buttons'>
                                    ...
                                    <li class='l pushBtnLabel ' id='ptype_label_1'
                                        onclick='pushBtnClick(this,"ptype","1")' title='Homes'>
                                        <span class='span'>Homes</span>
                                    </li>
                                    <li class='l pushBtnLabel ' id='ptype_label_2'
                                        onclick='pushBtnClick(this,"ptype","2")' title='Plots'>
                                        <span class='span'>Plots</span>
                                    </li>
                                    <li class='l pushBtnLabel ' id='ptype_label_3'
                                        onclick='pushBtnClick(this,"ptype","3")' title='Commercial'>
                            ...
                            <div class="divrow zameen-city-box">
                                <label class="label l font_s">City: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /></label>
                                <div class=''><select name='city' onchange='onchange_city(this)' id='city'>
                                        <option value='' selected>Select City</option>
                                        <option value='3'>Islamabad</option>
                                        <option value='2'>Karachi</option>
                                        <option value='1'>Lahore</option>
                                        <option value='41'>Rawalpindi</option>
                                        <option value='385'>Abbottabad</option>
                                ...
                                <div class="city_rest_tooltip"
                                    style="position: relative; top: -20px; left: 245px; display: none;"><img
                                        class="bgc"
                                        src="https://profolio.zameen.com/images/common/exclamation.gif"
                            ...
                            <div class="divrow">
                                ...
                                <div class=" empty_city" id="loc_selector_row">
                                    ...
                                    <div id="cat_selector" class="l cat_selector">
                                        <span id='_cat_selector_0_sel_box' class='sb_combo sel_box '
                                            style='width:210px'><select name='_cat_selector_0' id='_cat_selector_0'
                            ...
                            <div class="divrow field_detailed" id="div_address" style="display:none">
                                ...
                                <span class="l span" id="sp_unit">
                                    ...
                                    <input type='text' name='unit_no' id='unit_no' value='' style='width:76px;'
                                        class='rfield l ' /> </span>
                                ...
                                <span class="l span" id="sp_plot">
                                    ...
                                    <input type='text' name='plot_no' id='plot_no' value='' style='width:76px;'
                                        class='rfield l ' /> </span>
                            </div>
                            <!-- MAP -->
                            <div class="divrow" id="map_div" style="display:none">
                                ...
                                <a class="link_select_loc l" onclick="show_map_enlarged({map_field_id:'map_field'})"
                                    rel="nofollow" title="Click the map to select your location">
                                    <img id="small_map" />
                                </a>
                                ...
                                <input type="hidden" id="map_field"
                                    value="zoom=16&call_back=map_select_default&small_map=#small_map"
                                    autocomplete="off" />
                            ...
                            <div class="subhead font_s ros subhead2" id="property_box_heading">PROPERTY SPECS AND PRICE
                            </div>
                            <div class="divrow">
                                <label class="label l font_s">Area Size: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /> </label>
                                <input type='text' name='area' id='area' value='' style='width:135px;'
                                    class='rfield l ' /> <label class="label_inline l font_s">Unit: </label>
                                <span id='unit_sel_box' class='sb_combo sel_box ' style='width:135px'><select
                                        name='unit' id='unit' style='width:136px;' autocomplete='off'>
                                    ...
                                    <span class='bgc sb_combo_arrow r'>&nbsp;</span>
                                </span> <span class='bgc infologo2' onmouseover="land_convert_txt2(this,'')">Area
                                    Calculator</span> <input type="hidden" id="db_area" value="" />
                            ...
                            <div class="divrow div_beds" id="div_beds">
                                ...
                                <span id='beds_sel_box' class='sb_combo sel_box ' style='width:150px'><select
                                        name='beds' id='beds' style='width:151px;' autocomplete='off'>
                            ...
                            <div class="divrow div_bathrooms" id="div_bathrooms">
                                ...
                                <span id='baths_sel_box' class='sb_combo sel_box ' style='width:150px'><select
                                        name='baths' id='baths' style='width:151px;' autocomplete='off'>
                                        <option value='' selected>Please Select</option>
                                        <option value='1'>1</option>
                                        <option value='2'>2</option>
                                        <option value='3'>3</option>
                            ...
                            <div class="divrow div_oc_status field_detailed" id="div_oc_status">
                                ...
                                <span id='occupancy_status_sel_box' class='sb_combo sel_box '
                                    style='width:150px'><select name='occupancy_status' id='occupancy_status'
                                    ...
                                    <label class="label l font_s" style="width: auto; margin: 0px 6px;">Occupied
                                        Till:</label>
                                    <span id='occupancymonth_sel_box' class='sb_combo sel_box '
                                        style='width:102px'><select name='occupancymonth' id='occupancymonth'
                                            style='width:103px;' autocomplete='off'>
                                        ...
                                        <span class='bgc sb_combo_arrow r'>&nbsp;</span>
                                    </span><span id='occupancyyear_sel_box' class='sb_combo sel_box '
                                        style='width:102px'><select name='occupancyyear' id='occupancyyear'
                                            style='width:103px;' autocomplete='off'>
                            ...
                            <div class="divrow price_div">
                                <label class="label l font_s pheading display-block">Total Price: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /> </label>
                                <input type='text' name='price' id='price' value='' style='width:228px;'
                                    class='rfield l ' />
                            </div>
                            <div class="divrow price_div">
                                <label class="label l font_s">&nbsp;</label>
                            ...
                            <div class="instalments-box " style="display: none;">
                                ...
                                <div class="divrow">
                                    <label class="label l font_s pheading display-block">No. of Remaining Installments:
                                        <img src='https://profolio.zameen.com/images/common/asteriskred.gif' /> </label>
                                    <input type='text' name='no_of_instalments' id='no_of_instalments' value=''
                            ...
                            <div class="divrow div_features" style="display:none">
                                <label class="label l font_s">&nbsp;<span
                                        class="feature_label">Features:</span></label>
                            ...
                            <div class="divrow div_features" style="display:none">
                                <label class="label l font_s">&nbsp;<span
                                        class="feature_label">Features:</span></label>
                                <span class="l num_of_feature_text"> <span class='features_count'></span> Features
                                    Selected</span>
                            ...
                            <div id="rental_prices" style="display:none">
                                ...
                                <div class="divrow" style="display:block">
                                    ...
                                    <span id='txt_contract_period_sel_box' class='sb_combo sel_box '
                                        style='width:150px'><select name='txt_contract_period' id='txt_contract_period'
                                            style='width:151px;' autocomplete='off'>
                                            <option value='' selected>Please Select</option>
                                            <option value='1'>1</option>
                                            <option value='2'>2</option>
                                ...
                                <div class="divrow" style="display:block">
                                    <label class="label l font_s">Monthly Rent: <img
                                            src='https://profolio.zameen.com/images/common/asteriskred.gif' /></label>
                                    <input type='text' name='rental' id='rental' value='' style='width:136px;'
                                        class='rfield l ' />
                                </div>
                                <div class="divrow">
                                    <label class="label l font_s">&nbsp;</label>
                                ...
                                <div class="divrow" style="display:block">
                                    ...
                                    <input type='text' name='security_deposit' id='security_deposit' value=''
                                        style='width:136px;' onblur='rentalFieldsBlur(this);' class='rfield l ' />
                                    <label class="label_inline l font_s">or</label>
                                ...
                                <div class="divrow" style="display:block">
                                    ...
                                    <input type='text' name='advance_rent' id='advance_rent' value=''
                                        style='width:136px;' onblur='rentalFieldsBlur(this);' class='rfield l ' />
                                    <label class="label_inline l font_s">or</label>
                                    <input type='text' name='advance_rent_perc' id='advance_rent_perc' value=''
                                        style='width:85px;' onblur='rentalFieldsBlur(this);' class='rfield l ' /> <label
                                        class="label_inline l font_s">number of month's rental amount </label>
                                </div>
                            </div>
                            ...
                            <div id="UploadImages" class="uploaderbox uploaderbox_images UploadImages noItems">
                                ...
                                <div class="clr info_msg l drag_images_message" style="margin-bottom: 13px;">Drag &
                                    drop images to change order</div>
                                <div class="clr info_msg l multipleuploader" style="margin-bottom: 13px;display:none">
                                    Please use firefox or chrome to upload multiple images at once</div>
                                ...
                                <div class="clr">
                                    <div class="filecontrol_images">
                                        ...
                                        <div class="info_msg l multiple_key_message">Press CTRL key while selecting
                                            images to upload multiple images at once</div>
                                        <input type="hidden" id="image_ids" name="image_ids" value=""
                                            autocomplete="off" />
                                        <a class="orng_smore get_image_bank clr l"
                                            onclick="get_from_bank(this,'get_image_bank')"
                            ...
                            <div id="Uploadvideos" class="uploaderbox Uploadvideos noItems">
                                ...
                                <div class="clr info_msg l drag_videos_message" style="margin-bottom: 13px;">Drag &
                                    drop videos to change order</div>
                                ...
                                <li id='ListItem_' class='ListItem video_listing_zpt' style='display:none;'>
                                    ...
                                    <div class='l subdiv'>
                                        <div class='drow'>
                                            <span>Video Status:</span> <input type='text'
                                                class='rfield l video_status readonly' name='video_status[]'
                                                value='Pending' disabled />
                                        </div>
                                        <div class='drow'>
                                            <span>Video Link:</span> <input type='text' class='rfield l'
                                                name='video_link[]' value='' />
                                            <span>Video Title:</span> <input type='text' class='rfield l'
                            ...
                            <div id="Uploaddocuments"
                                class="uploaderbox uploaderbox_documents Uploaddocuments noItems">
                                <div class="subhead font_s ros subhead_img">Documents</div>

                                <div class="clr info_msg l drag_documents_message" style="margin-bottom: 13px;">Drag &
                                    drop documents to change order</div>
                                ...
                                <div class="clr">
                                    <div class="filecontrol_documents">
                                        ...
                                        <div class="info_msg l multiple_key_message">Press CTRL key while selecting
                                            documents to upload multiple documents at once</div>
                            ...
                            <div class="divrow">
                                ...
                                <span id='listing_owner_sel_box' class='sb_combo sel_box ' style='width:242px'><select
                                    ...
                                    <span class='bgc sb_combo_arrow r'>&nbsp;</span>
                                </span> <a class="l add_price_breakdown" style="margin-left: 10px;"
                                    href="javascript:void(0)" onclick='show_users_list();'>Load user info</a>
                            </div>
                            ...
                            <div class="divrow">
                                <label class="label l font_s">Contact Person: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /> </label>
                                <input type='text' name='name' id='name' value='Muhammad Rizwan Akhtar'
                                    style='width:228px;' class='rfield l ' />
                ...
                -->
                            <div class="divrow put_cell_input_after_this">
                                ...
                                <span class="ph_input_box l">
                                    <input type='text' name='phone0' id='phone0' value='' style='width:33px;'
                                        maxlength='6'
                                    ...
                                    <input type='text' name='phone1' id='phone1' value='' style='width:33px;'
                                        maxlength='6'
                                        onfocus='overlib_info(this,"Enter your area code.&lt;br /&gt;Example: +92-&lt;b class=red&gt;51&lt;/b&gt;-1234567")'
                                        class='rfield l ' /> <label class="separator">-</label>
                                    <input type='text' name='phone2' id='phone2' value='' style='width:112px;'
                                        maxlength='500'
                                        onfocus='overlib_info(this,"Enter your phone number.&lt;br /&gt;Example: +92-51-&lt;b class=red&gt;1234567&lt;/b&gt;")'
                                        class='rfield l ' /> </span>
                                <div class="bgc infologo r">
                                    <p>Enter your phone (land line or fixed phone) number along with area and
                                        international dialing code.<br />Example: +92-51-12345678</p>
                                </div>
                            </div>
                            ...
                            <div class="divrow cellinputs">
                                <label class="label l font_s">Mobile #1: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /></label>
                                <span class="ph_input_box l">
                                    <input type='text' name='cell[]' id='cell1' value='' style='width:245px;'
                                        maxlength='100' class='rfield l ' /><span id="valid-msg-cell1"
                                        class="valid-msg-cell" style="display: none"></span>
                                    <span id="error-msg-cell1" onmouseover="show_cell_message_tooltip(this)"
                                        class="error-msg-cell" style="display: none"></span> </span>

                                <div class="bgc infologo r">
                                    <p>Enter your mobile number along with international dialing code.<br />Example:
                                        +92-3001234567</p>
                                </div>
                            ...
                            <div class="divrow">
                                <label class="label l font_s">Email: <img
                                        src='https://profolio.zameen.com/images/common/asteriskred.gif' /></label>
                                <input type='text' name='email' id='email' value='rizwan.13347@gmail.com'
                                    style='width:228px;' class='rfield l ' />
                            </div>
                            ...
                            <input type="submit" name="add_property" value="1"
                            ...
                            <div class="divrow btn-sec-bottom">
                                <label class="label l font_s"> &nbsp;</label>
                                <span style="display:none;" id="direct_submit"
                                    class="btn1 submit_button l bgdgry ros smargin" onclick="submit_button_click();">
                    ...
                    <div id='hidden_type_1' style='display:none'>
                        <ul id='type_push_buttons' class='l push_buttons'>
                            ...
                            <li class='l pushBtnLabel ' id='type_label_9' onclick='pushBtnClick(this,"type","9")'
                                title='House'>
                                <span class='span'>House</span>
                            </li>
                            <li class='l pushBtnLabel ' id='type_label_8' onclick='pushBtnClick(this,"type","8")'
                                title='Flat'>
                            ...
                            <li class='l pushBtnLabel ' id='type_label_24' onclick='pushBtnClick(this,"type","24")'
                                title='Room'>
                    ...
                    <div id='hidden_type_3' style='display:none'>
                        <ul id='type_push_buttons' class='l push_buttons'>
                            ...
                            <li class='l pushBtnLabel ' id='type_label_13' onclick='pushBtnClick(this,"type","13")'
                                title='Office'>
                                <span class='span'>Office</span>
                            </li>
                            <li class='l pushBtnLabel ' id='type_label_15' onclick='pushBtnClick(this,"type","15")'
                                title='Shop'>
                            ...
                            <li class='l pushBtnLabel ' id='type_label_14' onclick='pushBtnClick(this,"type","14")'
                                title='Factory'>
                            ...
                            <li class='l pushBtnLabel ' id='type_label_18' onclick='pushBtnClick(this,"type","18")'
                                title='Other'>
                ...
                <span class="hot_listings_txt" style="display: none;">Hot listings generate <b>400% more exposure</b>
                    and response as compared to basic listings<br /><br />Displayed on <b>home page</b> as featured
                    properties with <b>top ranks</b> and positions in their respective categories<br><br>Please contact
                    your Account Manager or Zameen.com's Customer Service to purchase Super Hot/Hot listing
                    credits.</span>
                <span class="olx_feature_txt" style="display: none;">Get noticed with 'FEATURED' tag in a top position
                    and attract more buyers.</span>
                <span class="mark_feature_pending_txt" style="display: none;">Listing can't be make featured in pending
                    state.</span>
                <span class="super_hot_listings_txt" style="display: none;">Super Hot listings offer 5 times more
                    exposure compared to Hot Listings, and 20 times more exposure than basic listings.<br><br>Every
                    Super Hot listing comes with the option to get videos made and photos taken of your property by
                    Zameen.com’s expert team.<br><br>Enjoy top ranks in searches, receive exponentially increased
                    response, and sell or rent out your properties quicker than ever.<br><br>Please contact your Account
                    Manager or Zameen.com's Customer Service to purchase Super Hot/Hot listing credits.</span>
                ...
                <div class="jeffi_task" style="display: none;">
                    ...
                    <form id="jeffi_task_form" style="height:240px">
                        Zameen.com provides a special photography and videography service for your properties with Super
                        Hot Listings. Please choose which of these services, or both, you would like to avail:<br><br>
                        <input type="checkbox" id="check_photo" name="check_photo" /><label
                        ...
                        <div>Please choose a date and time for our Media Associate to visit your property using the
                            panel below (this service is not available on Saturdays and Sundays):</div><br>
            ...
            <script type="text/javascript">
                ...
                if (edit_property_page) {
                    ...
                    edit_page_redirect_url =
                        "https://profolio.zameen.com/profolio/index.php?section=add_property&tabs=2&step=5&id=0&property_user_id=1001388906";
                    $(function() {
