...
<div id="rightcolumn" style="
    ...
    <div id="add_prop_main" class="add_prop_main step_1 purpose_ AdvanceSubmision">
        ...
        <div class="add_property_page step_1 purpose_ ">
            <form class="add_property add_property_form singleForm clr" method="post" autocomplete="off" action="{{ $url }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="divrow">
                    ...
                    <input type='text' name='title' id='title' value="{{ $record->name ?? '' }}" style='width:419px;' class='rfield l ' placeholder='Enter property title here...' /><br>
                ...
                <div class="divrow">
                    ...
                    <textarea name="description" id="description" style="width:418px" rows="5" class="rfield l" placeholder="Enter property description here...">{{ $record->descripition ?? '' }}</textarea><br>
                ...
                <div class="divrow">
                    <label class="label l font_s">Front Dimenssion (ft): <img src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                    <input type='text' name='front_dim' id='area' value='{{ $record->front_dim ?? '' }}' style='width:135px;' class='rfield l' placeholder="Enter front dimenssion..." />
                ...
                <div class="divrow">
                    <label class="label l font_s">Back Dimenssion (ft): <img src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                    <input type='text' name='back_dim' id='area' value='{{ $record->back_dim ?? '' }}' style='width:135px;' class='rfield l ' placeholder="Enter back dimenssion..." />
                ...
                <div class="divrow price_div">
                    ...
                    <input type='text' name='price' id='price' value="{{ $record->price ?? '' }}" style='width:228px;' class='rfield l ' placeholder="Enter price..." />
                </div>
                <div class="divrow zameen-city-box" style="width: 50%;margin: 0 auto;width: 20;">
                    @if ($errors->has('price'))
                                    ...
                                    <li class="fl-wrap filter-tags clearfix">
                                        <div class="filter-tags-wrap">
                                            ...
                                            if (isset($record) && !empty($record)) { ?>
                                                ...
                                                <label style="font-size: 16px;font-weight: 100;">{{ Form::checkbox('feature[]', $feature->id, in_array($feature->id, $features_property) ? true : false, ['class' => 'name']) }}
                                                    {{ $feature->name }}</label>
                                                @endforeach
                                            <?php
                                            } else { ?>
