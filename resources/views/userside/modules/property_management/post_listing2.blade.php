...
@section('main')
    ...
    <div id="rightcolumn" style="width:79% " class="rightcolumn_div post_story_margin">
        ...
        <div id="add_prop_main" class="add_prop_main step_1 purpose_ AdvanceSubmision">
            ...
            <div class="add_property_page step_1 purpose_ ">
                <form class="add_property add_property_form singleForm clr" method="post" autocomplete="off"
                    ...
                    ?>
                    <input type="hidden" name="agency_id" value="{{ $agency_id->id ?? '' }}">
                    <div class="divrow">
                    ...
                    <div class="divrow">
                        ...
                        <div class="lat col-lg-2 col-md-12 d-none">
                            <p class="no-mb first" style="margin-bottom: 4px;">
                                ...
                                <input type="text" value="{{ old('latitude') }}" name="latitude" step="0.01"
                                    id="lat">
                            </p>
                        </div>
                        <div class="lat col-lg-2 col-md-12 d-none">
                            <p class="no-mb first" style="margin-bottom: 4px;">
                                ...
                                <input type="text" value="{{ old('longitude') }}" name="longitude" step="0.01"
                                    id="long">
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="divrow">
                        <label class="label l font_s">Property Title: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /></label>
                        <input type='text' name='title' id='title' value="{{ $record->name ?? '' }}"
                            style='width:419px;' class='rfield l ' placeholder='Enter property title here...' /><br>
                        ...
                        <input class="form-control txtPageUrl" placeholder="Url Slug" id="url_slug" name="url_slug"
                            value="{{ $record->url_slug ?? '' }}" type="hidden" readonly>
                    </div>
                    ...
                    <div class="divrow">
                        <label class="label l font_s">Area Size: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        <input type='text' name='land_area' id='' value="{{ $record->land_area ?? '' }}"
                    ...
                    <div class="divrow">
                        <label class="label l font_s">Front Dimenssion (ft): <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        ...
                        <span style="color: #FF385C; margin-left:10px;">( Please Enter a Front dimenssion In ft )</span>
                    </div>
                    <div class="divrow zameen-city-box" style="width: 50%;margin: 0 auto;width: 20;">
                    ...
                    <div class="divrow">
                        <label class="label l font_s">Back Dimenssion (ft): <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        ...
                        <span style="color: #FF385C; margin-left:10px;">( Please Enter a Back Dimenssion In ft )</span>
                    </div>
                    <div class="divrow zameen-city-box" style="width: 50%;margin: 0 auto;width: 20;">
                    ...
                    <div class="divrow bed d-none">
                        <label class="label l font_s">Bedrooms: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        <input type='text' name='number_of_bedrooms' id='area'
                            value="{{ $record->number_of_bedrooms ?? '' }}" style='width:135px;' class='rfield l'
                            placeholder="Number of bedrooms..." />
                    </div>
                    <div class="divrow bed d-none">
                        <label class="label l font_s">Bathrooms: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        <input type='text' name='number_of_bathrooms' id='area'
                            value="{{ $record->number_of_bathrooms ?? '' }}" style='width:135px;' class='rfield l'
                            placeholder="Number of bathrooms..." />
                    </div>
                    <div class="divrow bed d-none">
                        <label class="label l font_s">Floors: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        <input type='text' name='number_of_floors' id='area'
                            value="{{ $record->number_of_floors ?? '' }}" style='width:135px;' class='rfield l'
                            ...
                            <div class="filecontrol_images">
                                ...
                                @else
                                    <input type="file" name="image[]" class="dropify notrequired"
                                        data-default-file="" data-height="180" multiple />
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="divrow">
                        <label class="label l font_s">Video Link: <img
                                src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                        <input type='text' name='video_link' value="" style='width:135px;' class='rfield l '
                    ...
                    <div class="divrow">
                        @if (Auth::user()->contact)
                            ...
                            <input placeholder="Enter contact number..." type='text' name='contact'
                                id="account-phone" value='{{ Auth::user()->contact }}' style='width:228px;'
                                class='rfield l ' />
                        @else
                            <label class="label l font_s">Contact number: <img
                                    src="{{ asset('userside') }}/images/common/asteriskred.gif" /> </label>
                            <input placeholder="Enter contact number..." type='text' name='contact'
                                id="account-phone" value='+92' style='width:228px;' class='rfield l ' />
                        @endif
                    </div>
                    <div class="divrow zameen-city-box" style="width: 50%;margin: 0 auto;width: 20;">
        ...
        <span class="mark_feature_pending_txt" style="display: none;">Listing can't be make featured in pending
            state.</span>
        <span class="super_hot_listings_txt" style="display: none;">Super Hot listings offer 5 times more exposure
            compared
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=initialize&key=AIzaSyCYMlyYs_qCEHhoOsYq3QhRC_0v69Drnco">
    </script>
    <script>
        function initialize() {
