...
<section class="banner-section home-3">
					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-6 col-12">
                            <div class="banner-round">
                                <img src="{{asset('Front')}}/assets/images/banner/home-3/01.png" alt="banner">
                            </div>
                        </div>
					</div>
				</div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="about-thumb">
                            <img src="{{asset('Front')}}/assets/images/about/home-3/01.png" alt="about">
                        </div>
                    </div>
                        ...
                        <div class="about-content">
                            <div class="ab-title">
                                ...
                                <ul class="lab-ul">
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/01.jpg" alt="ab-thumb">
                                        </div>
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/02.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/03.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
		...
		<section class="service-section home-3 padding-tb" style="background-image: url({{asset('Front')}}/assets/css/bg-image/service-bg.jpg);">
            <div class="container">
                    ...
                    <div class="row no-gutters justify-content-center">
                            ...
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/01.jpg" alt="service">
                                    </div>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/02.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Hot Fever</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/03.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/04.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/05.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Confusion</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="{{asset('Front')}}/assets/images/service/home-3/service/06.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Sore Throat</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
        ...
        <section class="about-section style-3 bg-about padding-tb">
            <div class="container">
                <div class="row justify-content-center align-items-center flex-row-reverse">
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="about-thumb">
                            <img src="{{asset('Front')}}/assets/images/about/home-3/02.png" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="about-content">
                            <div class="ab-title">
                                ...
                                <ul class="lab-ul">
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/04.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/05.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="{{asset('Front')}}/assets/images/about/icon/home-3/06.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
        ...
        <div class="team-section home-2 padding-tb" style="background-image: url({{asset('Front')}}/assets/css/bg-image/service-bg.jpg);">
            <div class="container">
				<div class="section-header wow fadeInUp" data-wow-delay="0.3s">
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-xl-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
							<div class="team-item style-2">
								<div class="team-item-inner">
									<div class="team-thumb">
										<img src="{{asset('Front')}}/assets/images/team/02.jpg" alt="team-membar">
									</div>
									<div class="team-content">
						...
						<div class="col-xl-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.5s">
							<div class="team-item style-2">
								<div class="team-item-inner">
									<div class="team-thumb">
										<img src="{{asset('Front')}}/assets/images/team/03.jpg" alt="team-membar">
									</div>
									<div class="team-content">
			...
			<div class="container">
				...
				<div class="row justify-content-center align-items-center" style=" counter-reset: topx;">
					<div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/01.jpg" alt="safe">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/02.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Apply Soap</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/03.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/04.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/05.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/06.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/07.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Clean Thumbs</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/08.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/09.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Rinse Hands</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/10.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/11.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="{{asset('Front')}}/assets/images/safe/home-3/12.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
        ...
        <!-- Service Section Start Here -->
		<section class="service-section home-3 style-2 padding-tb" style="background-image: url({{asset('Front')}}/assets/css/bg-image/service-bg.jpg);">
            <div class="container">
                <div class="section-header wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/01.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/02.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/03.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/04.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/05.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/06.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/07.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="{{asset('Front')}}/assets/images/service/home-3/08.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{asset('Front')}}/assets/images/blog/01.jpg" alt="lab-blog"></a>
                                    </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{asset('Front')}}/assets/images/blog/02.jpg" alt="lab-blog"></a>
                                    </div>
                                    <div class="post-content">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="{{asset('Front')}}/assets/images/blog/03.jpg" alt="lab-blog"></a>
                                    </div>
                                    <div class="post-content">
