									...
									<div class="d-flex order-lg-2 ml-auto">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class="header-dropdown-list message-menu" id="message-menu">
													...
													<a class="dropdown-item border-bottom">
														<div class="d-flex align-items-center">
															<div class="">
																<span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{URL::asset('assets/images/userphoto/'.Auth()->user()->image ?? '')}}"></span>
															</div>
															<div class="d-flex">
																<div class="pl-3">
										...
										<div class="dropdown profile-dropdown">
											<a href="{{url('/' . $page='#')}}" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="{{URL::asset('assets/images/userphoto/'.Auth()->user()->image ?? '')}}" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												...
												<a class="dropdown-item d-flex" href="{{url('admin/edit_profile/'.auth()->user()->id)}}">
