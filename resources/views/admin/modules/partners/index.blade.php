    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:create_partners') }}" class="btn btn-primary"><i class="fe fe-user mr-1"></i> Add
                    New</a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Partners Listing</div>
                </div>
                <div class="card-body">
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td><img src="{{ asset('assets/images/partners/' . $item->image) }}"
                                            ...
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('admin:create_partners', ['id' => $item->id]) }}">
...
@section('js')
    ...
    <script src="{{ URL::asset('assets/themeJquery/partners/jquery.js') }}"></script>
@endsection
