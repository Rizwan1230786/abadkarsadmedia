    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:create_team')}}" class="btn btn-success"><i class="fe fe-user mr-1"></i> Add
                    New</a>
                        ...
                        <table class="table table-bordered text-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p border-bottom-0">Desigination</th>
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('uploads/teams/orignal_images/'.$item->image) }}" width="80px"></td>
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('admin:create_team', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="Edit"></i></li></a>
                                                    @if($status == 1)
