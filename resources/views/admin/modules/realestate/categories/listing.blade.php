    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:categories.form')}}" class="btn btn-success"><i class="fe fe-user mr-1"></i> Add
                    New</a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Categories Listing</div>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="icons-list">
                                                    ...
                                                    <a href="{{ route('admin:subcategories', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="sub category"></i></li></a>
                                                    <a href="#">
