        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Users Listing</div>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="icons-list">
                                            ...
                                            @endif
                                            <a href="javascript:void(0)">
                                                <li class="icons-list-item delete_user" data-id="{{ $item->id }}"><i class="fa fa-trash-o"  data-toggle="tooltip" title="" data-original-title="Delete"></i></li>
                                            </a>
                                        </ul>
                                    </td>
                                </tr>
