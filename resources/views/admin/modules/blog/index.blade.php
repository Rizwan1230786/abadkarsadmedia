...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Our Blog</h4>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:create_blog')}}" class="btn btn-success"><i class="fe fe-user mr-1"></i> Add
                    New</a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Our Blog</div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-25p border-bottom-0">Tittle</th>
                                    <th class="wd-25p border-bottom-0">image</th>
                                    <th class="wd-25p border-bottom-0">url_slug</th>
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->tittle }}</td>
                                            <td><img src="{{ asset('uploads/blogs/orignal_images/'.$item->image) }}" width="80px"></td>
                                            <td>{{ $item->url_slug }}</td>
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('admin:create_blog', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="Edit"></i></li></a>
                                                    @if($status == 1)
