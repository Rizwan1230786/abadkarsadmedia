...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Tools</h4>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:tools.form')}}" class="btn btn-primary"><i class="fe fe-user mr-1"></i> Add
                    New</a>
                            ...
                            <tbody>
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><img src="{{asset('assets/images/tools/'.$item->image)}}" width="50px" height="50px"></td>
                                            <td>{{ $item->name}}</td>
                                            <td>{{ $item->detail}}</td>
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('admin:tools.form', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="Edit"></i></li></a>
                                                    <a href="#">
