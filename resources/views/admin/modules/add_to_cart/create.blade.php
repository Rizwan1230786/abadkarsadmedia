...
<div class="page-header">
    ...
    <div class="page-rightheader">
        <div class="btn btn-list">
            <a href="{{ route('admin:product') }}" class="btn btn-primary"><i class="fe fe-block mr-1"></i> Back </a>
        </div>
    </div>
</div>
@endsection
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <form class="validationForm formSubmited" id="myForm" enctype="multipart/form-data" method="POST" action="{{ route('admin:facilites_submit', [$data['updateId'] ?? 0]) }}">
                            @csrf
                            ...
                            <div class="card-body pb-2">
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input class="form-control notrequired" placeholder="Name" name="price" value="{{ $data['record']->price ?? '' }}" type="number">
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="btn btn-list" style="text-align:center;width:100%">
                                            ...
                                            <button type="button" href="{{ route('admin:product') }}" class="btn btn-warning">Cancel </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="{{ URL::asset('assets/themeJquery/product/jquery.js') }}"></script>
@endsection
