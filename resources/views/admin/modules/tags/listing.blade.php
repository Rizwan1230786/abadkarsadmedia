    ...
    <div class="page-header">
        ...
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="{{ route('admin:tags.form')}}" class="btn btn-primary"><i class="fe fe-user mr-1"></i> Add
                    New</a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Tags Listing</div>
                </div>
                <div class="card-body">
                                ...
                                @isset($record)
                                    @foreach ($record as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="icons-list">
                                                    <a href="{{ route('admin:tags.form', ['id'=>$item->id]) }}"><li class="icons-list-item"><i class="fe fe-edit-3" data-toggle="tooltip" title="" data-original-title="Edit"></i></li></a>
                                                    <a href="#">
