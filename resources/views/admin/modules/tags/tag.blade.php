...
@endsection
@section('page-header')               
               <form action="{{url('/admin/create/tag')}}" enctype="multipart/form-data" method="Post">
               @csrf
               ...
               <div class="card-body pb-2">
                           ...
                           <div class="col-6 form-group">
                                        ...
                                        <input class="form-control notrequired" placeholder="Tags Name" name="name"  type="text">
                                    </div>
