...
class ProjectController extends BaseController
{
        ...
        SaveFacilitiesService $saveFacilitiesService)
    {
        ...
        $project->commercial_max = $request->input('commercial_max');
        $project->commercial_min = $request->input('commercial_min');
        $project->residential_max = $request->input('residential_max');
        $project->residential_min = $request->input('residential_min');
