        ...
        $this
            ...
            ->add('currency_id', 'customSelect', [
                ...
                'choices'    => $currencies,
                 ...
                 ->add('commercial_min', 'number', [
                'label'      => trans('Commercial Area'),
                'name'      => ['commercial_min'],
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                ...
                'attr'       => [
                    'placeholder' => trans('size in marala (min)'),
                ],
            ])
            ->add('commercial_max', 'number', [
                'label'      => trans('Commercial Area'),
                'name'       =>['commercial_max'],
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                ...
                'attr'       => [
                    'placeholder' => trans('size in marala (max)'),
                ],
            ])
            ->add('residential_min', 'number', [
                'label'      => trans('Residential Area'),
                'name'       =>['residential_min'],
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 col-md-3',
                ],
            ...
            ->add('residential_max', 'number', [
                'label'      => trans('Residential Area'),
                'name'       =>['residential_max'],
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 col-md-3',
                ],
