                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6 lineheight220">
                             <div><span>{{ __('Project ID') }}:</span> <b>{{ $project->id }}</b></div>
                        ...
                        <div class="col-sm-6 lineheight220">
                            ...
                            @if ($project->number_flat) <div><span>{{ __('Number of flats') }}:</span> <b>{{ number_format($project->number_flat) }}</b></div>@endif
                              @if ($project->residential_max || $project->residential_min)
                            <div>
                                <span>{{ __('Residential Area') }}:</span>
                                <b>
                                    @if ($project->residential_min)
                                        <span class="from">{{ __('From') }}</span>
                                        {{ $project->residential_min }}
                                    @endif
                                    @if ($project->residential_max)
                                        - {{ $project->residential_max }} marla
                                    @endif
                                </b>
                            </div>
                        @endif
                        @if ($project->commercial_max || $project->commercial_min)
                        <div>
                            <span>{{ __('Commercial Area') }}:</span>
                            <b>
                                @if ($project->commercial_min)
                                    <span class="from">{{ __('From') }}</span>
                                    {{ $project->commercial_min }}
                                @endif
                                @if ($project->commercial_max)
                                    - {{ $project->commercial_max }} marla
                                @endif
                            </b>
                        </div>
                    @endif
