     ...
     $.fn.autoSuggest = function(data, options) {
         ...
         if ((d_type == "object" && d_count > 0) || d_type == "string" || d_type == "function") {
             return this.each(function(x) {
                 ...
                 if (typeof opts.preFill.length == "undefined" && input.attr("data-value")) //automatically use data-value to autofill
                 {
                     data_handler(data);
                     ...
                     for (r = 0; r < vals.length; r++) {
                         for (var i = 0; i < data_array.length; i++) {
                             if (vals[r] == data_array[i][opts.selectedValuesProp]) {
                                 add_selected_item(data_array[i], "000" + i);
                                 break;
                             }
                         }
                     }
                 ...
                 function processData(data, query) {
                     ...
                     for (var i = 0; i < d_count; i++) {
                         ...
                         if (forward) {
                             var formatted = $('<li class="as-result-item ' + typing_lang + '" id="as-result-item-' + num + '"></li>').click(function() {
                 ...
                 function add_selected_item(data, num) {
                     ...
                     var item = $('<li class="as-selection-item ' + typing_lang + '" id="as-selection-' + num + '"></li>').click(function() {
