(function(factory) {
    ...
    Plugin.prototype = {
        ...
        _setFlag: function(countryCode) {
            ...
            if (prevCountry.iso2 !== countryCode) this.telInput.removeAttr("placeholder-data");
        ...
        _updatePlaceholder: function() {
            var hadPlaceholderData = Boolean(this.telInput.attr("placeholder-data"));
            var shouldSetPlaceholder = this.options.autoPlaceholder === "aggressive" || !this.hadInitialPlaceholder && !hadPlaceholderData && (this.options.autoPlaceholder === true || this.options.autoPlaceholder === "polite");
            if (window.intlTelInputUtils && shouldSetPlaceholder) {
                ...
                if (this.telInput.val() == '') this.telInput.attr("placeholder", placeholder);
                else
                    this.telInput.attr("placeholder-data", placeholder);
            }
        },
